...
const Login = ({ onLogin }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Login failed. Check email & password.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    ...
                    <Input id="login-email" data-testid="login-email-input" type="email"
                  ...
                  <div>
                    ...
                    <Input id="login-password" data-testid="login-password-input" type="password"
              ...
              <TabsContent value="register">
                <form onSubmit={handleRegister} className="space-y-4">
                  <div>
                    ...
                    <Input id="register-name" data-testid="register-name-input" type="text"
                  ...
                  <div>
                    ...
                    <Input id="register-email" data-testid="register-email-input" type="email"
                           placeholder="seller@example.com" required
                  ...
                  <div>
                    ...
                    <Input id="register-password" data-testid="register-password-input" type="password"
                           placeholder="••••••••" required
        ...
        <p className="text-center text-sm text-slate-500 mt-6">© 2026 SellerVector. Powered by AI.</p>
      </div>
    </div>
  );
};
